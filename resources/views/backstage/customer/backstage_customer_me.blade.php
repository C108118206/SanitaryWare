        ...
        <div class="bg-white w-3/4 m-auto rounded-xl">
            <div class=" p-4">
                <form action="{{route('backstage-customer-me-store')}}" method="POST">
                    ...
                    <div class="mb-6">
                        <label for="fax" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">傳真</label>
                        <input type="text" name="fax"  value="{{ $self->fax }}"  id="fax" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Fax number (07-1234-5678)" required>
                    </div>
                    <div class="mb-6">
                        <label for="mail" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Email</label>
                        <input type="email" name="mail"  value="{{ $self->mail }}"  id="mail" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="E-mail (example@gmail.com)" required>
                    </div>
