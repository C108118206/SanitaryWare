                ...
                <form action="" method="post" class="flex">
                    ...
                    <div date-rangepicker class="flex items-center px-2">
                        <div class="relative">
                              ...
                              <input name="start" type="text" datepicker-format="yyyy-mm-dd" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
                          </div>
