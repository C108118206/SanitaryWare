            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 px-8">
                ...
                <form action="{{ route('backstage-news-store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        <label for="image" class="mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">上傳圖片 <br><span class="text-red-500">副檔名(jpg ,png ,jpeg ,gif ,svg)  限制大小為2Mb</label>
